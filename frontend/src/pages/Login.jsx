        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            <div className="d-flex justify-content-between align-items-center mb-1">
              <label className="form-label text-uppercase text-muted small fw-semibold mb-0" style={{ letterSpacing: '0.5px' }}>
                Password
              </label>
              <Link to="/forgot-password" style={{ color: '#D4AF37', fontSize: '0.8rem', textDecoration: 'none' }}>
                Forgot Password?
              </Link>
            </div>
            <input
